...
{
	return [NSString stringWithFormat:@"<%@ = %08X | Tag = %i | Color = %02X%02X%02X%02X | Size = %f,%f>", [self class], (int)self, _tag, color_.r, color_.g, color_.b, opacity_, size_.width, size_.height];
}
